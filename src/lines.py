...
from src.util.merging_utils import merge_with_candidates_dict, filter_small_island, lonlat_length_in_km, get_merged_and_divided_by_threshold, is_reverse_needed, reverse_linestring_coords, \
...
def main(input_path, output_path, nation, limit_relation_id, mode, tags, DEBUGGING=False, DIVIDE=None, LEVEL_DICT=None):
    ...
    line_df.to_file(f"{output_path}/unmerged.geojson", driver="GeoJSON", encoding="utf-8", index=False)
